  ...
  return (
    <>
      {!isTabletOrMobileDevice ? (
        <web.main
          style={{ marginTop:"50px",background: props.open.to([0, 1], ["#fff", "#FFFF00"]) }}
        >
          <web.h1
            style={{
          ...
          <Canvas dpr={[1, 2]} camera={{ position: [0, 0, 0], fov: 35 }}>
            <three.pointLight
              position={[10, 10, 10]}
              intensity={1.5}
              color={props.open.to([0, 1], ["#f0f0f0", "#FFFF00"])}
            />
      ...
      {!isTabletOrMobileDevice ? (
          ...
          {open && (
            <div className="topSection">
              ...
              <div className="typewriter">
                ...
                <h1 className="typing-erase" style={{ marginTop: "20px" }}>
                  <b>-John Johnson</b>
                </h1>
              </div>
            </div>
        ...
        <div>
          {open && (
            <>
            <div className="topSectionM">
              <img src={companyLogo} alt="BigCo Inc. logo" />

              <div className="typewriterM">
                <h1 className="typing-eraseM">
                  First Solve Problem Then Write Code.
                </h1>
                <h1 className="typing-eraseM" style={{ marginTop: "50px" }}>
                  <b>-John Johnson</b>
                </h1>
              </div>
            </div>
